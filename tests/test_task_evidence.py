...
loader = importlib.machinery.SourceFileLoader("task_cli", "cli/task")
...
- [x] done
"""
        Path(task.TASKS_DIR, "TASK-001-test-slug.md").write_text(task_body)
...
class VerifyCommandTests(unittest.TestCase):
    ...
    def test_verify_writes_pass_record_when_all_commands_succeed(self):
        ...
        self.assertIn("result: pass", files[0].read_text())
